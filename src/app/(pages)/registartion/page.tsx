          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit} >
            <label className="flex flex-col gap-2 text-left text-lg text-gray-600 font-semibold" >
              ...
              <input
                ...
                className={`mt-1 border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-none placeholder:text-gray-600 placeholder:text-sm  ${errors.name && touched.name ? "border-red-500" : "border-gray-300"}`}
              />
            </label>
            ...
            <label className="flex flex-col gap-2 text-left text-lg text-gray-600 font-semibold">
              ...
              <input
                ...
                className={`mt-1 border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-none placeholder:text-gray-600 placeholder:text-sm   ${errors.email && touched.email ? "border-red-500" : "border-gray-300"}`}
              />
            </label>
            ...
            <label className="flex flex-col gap-2 text-left text-lg text-gray-600 font-semibold">
              ...
              <input
                ...
                className={`mt-1 border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-none placeholder:text-gray-600 placeholder:text-sm   ${errors.phone && touched.phone ? "border-red-500" : "border-gray-300"}`}
              />
            </label>
            ...
            <label className="flex flex-col gap-2 text-left text-lg text-gray-600 font-semibold">
              ...
              <div className="flex flex-row gap-2 items-center justify-between">
                ...
                {/* )} */}
                <input
                  className={` w-4/5 mt-1 border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-none placeholder:text-gray-600 placeholder:text-sm   ${errors.image && touched.image ? "border-red-500" : "border-gray-300"}`}
                  type="file"
                  name="receipt"
